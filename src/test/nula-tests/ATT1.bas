...
VDU 23,241,&E0,&E0,&E0,&E0,&1C,&1C,&1C,&1C
...
FF%=F%((PAL%(FNc2l(C%))AND&F)EOR7)<>0:FB%=F%((PAL%(FNc2l(C%AND&6))AND&F)EOR7)<>0
N$=FNl2n(C%,TRUE)+"/"+FNl2n(C%AND&6,TRUE)
N2$=FNl2n(C%,NOTFF%)+"/"+FNl2n(C%AND&6,NOTFB%)
IFN2$<>N$THENN$=N$+"!"+N2$
=N$
...
DEFPROCmycol(A%):?&D2=(((A%AND1)=0)AND&FC)+(((A%AND4)<>0)AND&02)+(((A%AND2)<>0)AND&01):?&D3=(((A%AND1)=0)AND&FC):ENDPROC
REM DATA FOR NAMES
