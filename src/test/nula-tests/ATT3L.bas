    0REM >attributes type 3 test mode 4-ish with 3 bit attributes LOGICAL MODE
*VNRESET
*VNVDU ON
MODE 104
*FX 9 20
...
REM DATA FOR ULA PALETTE - LOGICAL mode: straight thru (invert bottom 3 bits)
DATA &F8, &E9, &DA, &CB, &BC, &AD, &9E, &80, &70, &61, &52, &43, &34, &25, &16, &07
